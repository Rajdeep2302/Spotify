...
const BodyDisplayHomeSpotifyPlaylist = ({image, name, desc, id}) => {
  ...
  return (
    <div className='min-w-[180px] p-2 px-3 m-2 rounded cursor-pointer hover:bg-[#ffffff36]' onMouseEnter={() => {
        const playButton = document.getElementById('playP');
        ...
        <div id='playP' className='hidden justify-end items-end' > 
        <div className='flex justify-center items-center h-10 w-10 bg-black rounded-full mb-[-40px] z-10' title={`play ${name}`}>
...
export default BodyDisplayHomeSpotifyPlaylist
